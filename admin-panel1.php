...
if(isset($_POST['delete']))
{
  ...
  $query="delete from patreg where email='$email';";
  $result=mysqli_query($con,$query);
  if($result)
    {
      echo "<script>alert('patients removed successfully!');</script>";
  }
  else{
...
if(isset($_POST['deletepid']))
{
  ...
  $pid=$_POST['deleteid'];
  $query="DELETE FROM prestb WHERE `prestb`.`pid` = '$pid';";
  $result=mysqli_query($con,$query);
  if($result)
    {
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> TATA Hospital Management System</a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-dpat" id="list-dpat-list"  role="tab" data-toggle="list" aria-controls="home">Delete Patients</a>
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel1.php#app-pat?deleteemail=<?php echo $row['email']; ?>"> -->
                        
                            <input type="checkbox" value="<?php echo $row['email']; ?>" name="deleteemail" id="" require>
                            <input type="submit" Value="Delete" name="delete" class="btn btn-danger btn-sm" style="border-radius:0%" onclick="confirm('do you really want to delete?')" >
                          <!-- </a> -->
                        </td>
                      </tr>
                  ...
                  <?php 
                    ...
                    <tr>
                      <td><?php echo "$cnt";?></td>
                        ...
                        <td><?php echo "$pres";?></td>
                        <td>  
                          <input type="checkbox" value="<?php echo $row['pid']; ?>" name="deleteid" id="" require>
                          <input type="submit" Value="Delete" name="deletepid" class="btn btn-danger btn-sm" style="border-radius:0%" onclick="confirm('do you really want to delete?')" >
                      </td>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <div class="col-md-4"><label>Doctor Name:</label></div>
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Pet dard thik krne vale" name="spec">Pet dard thik krne vale</option>
                      <option value="feaver tez vala thik krne vale" name="spec">feaver tez vala thik krne vale</option>
                      <option value="Sir dard thik krne vale">Sir dard thik krne vale</option>
                      <option value="All rounder" name="spec">All rounder</option>
                      <option value="vip dentist">vip dentist</option>
          ...
          <input type="submit" name="docsub" value="Add Doctor" class="btn btn-primary">
                        ...
                        <!-- this is a code for delete doctor -->
      ...
      <!-- for delete petent code -->
      <div class="tab-pane fade" id="list-dpat" role="tabpanel" aria-labelledby="list-settings1-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
          ...
          <input type="submit" name="del-pet" value="Delete Patients" class="btn btn-primary" onclick="confirm('do you really want to delete?')">
        </form>
      </div>
