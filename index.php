...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp TATA HOSPITAL MANAGEMENT SYSTEM</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="images\TATALOGO.png" alt="" />
                        <h3>Welcome</h3>
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#report" role="tab" aria-controls="admin" aria-selected="false">Report</a>
                            </li>
                        </ul>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                           <span> Already have an account?</span><a href="index1.php">Login Now</a>
                                        </div> 
                                    </div>
                        ...
                        <div class="tab-pane fade show" id="report" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Login for report</h3>
                                <form method="post" action="func4.php">
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="User Name *" name="username2" onkeydown="return alphaOnly(event);" required/>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" class="btnRegister" name="rsub" value="Login"/>
                                    </div>
                                </div>
                            </form>
                            </div>
